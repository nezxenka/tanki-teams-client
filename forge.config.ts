    ...
    makers: [
        {
            ...
            config: (arch: string) => ({
                options: {
                    ...
                    categories: ["Game"],
                    section: "games",
                    homepage: "https://tanks.aleskysha.ru",
                }
            })
        },
        {
            ...
            config: (arch: string) => ({
                name: `tanki-teams-${packageJSON.version}-darwin-${arch}`,
        ...
        },
        {
            ...
            config: (arch: string) => ({
                setupExe: `tanki-teams-${packageJSON.version}-win32-${arch}.exe`,
                iconUrl: `https://github.com/nezxenka/tanki-teams-client/releases/download/${packageJSON.version}/squirrel-icon-${packageJSON.version}.ico`,
